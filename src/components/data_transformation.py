...
class DataTransformation:
    ...
    def get_data_transformer_object(self) -> Pipeline:
        ...
        include gender mapping, dummy variables creation, column remaining,
        feature scaling, and type adjustment.
        """

        logging.info("Entered get data transformed object method of DataTransformation class")
        ...
        try: 
            ...
            logging.info("Exited get_data_transformer_object method of DataTrandformation class")

            return final_pipeline
        
        except Exception as e:
            logging.exception("Exception occured in get_data_tranformer_object method")
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        ...
        try:
            ...
            logging.info("Input and Traget cols defined for both train and test df.")

            #Apply custom transformation in specific sequence
            ...
            logging.info("SMOTTEEN applied to train-test df")
