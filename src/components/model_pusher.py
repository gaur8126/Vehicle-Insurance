...
class ModelPusher:
    ...
    def __init__(self, model_evaluation_artifact:ModelEvaluationArtifact, 
        ...
        self.vehicle_estimator = VehicleEstimator(bucket_name=model_pusher_config.bucket_name,
                                                  model_path=model_pusher_config.s3_model_key_path)
        
    def initiate_model_pusher(self) -> ModelEvaluationArtifact:
        ...
        try: 
            ...
            logging.info("Uploading new model to s3 bucker....")
            ...
            logging.info("Uplaoding artifacts folder to s3 bucket")
